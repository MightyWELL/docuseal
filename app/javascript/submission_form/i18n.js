const en = {
  ...
  save_signature_for_future_documents: 'Save my signature for future documents',
  save_initials_for_future_documents: 'Save my initials for future documents',
  approved: 'Approved',
  reviewed: 'Reviewed',
  other: 'Other',
...
const es = {
  ...
  save_signature_for_future_documents: 'Guardar mi firma para futuros documentos',
  save_initials_for_future_documents: 'Guardar mis iniciales para futuros documentos',
...
const it = {
  ...
  save_signature_for_future_documents: 'Salva la mia firma per i documenti futuri',
  save_initials_for_future_documents: 'Salva le mie iniziali per i documenti futuri',
...
const de = {
  ...
  save_signature_for_future_documents: 'Meine Signatur für zukünftige Dokumente speichern',
  save_initials_for_future_documents: 'Meine Initialen für zukünftige Dokumente speichern',
  approved: 'Genehmigt',
  reviewed: 'Geprüft',
  other: 'Sonstiges',
...
const fr = {
  ...
  save_signature_for_future_documents: 'Enregistrer ma signature pour les futurs documents',
  save_initials_for_future_documents: 'Enregistrer mes initiales pour les futurs documents',
  approved: 'Approuvé',
  reviewed: 'Révisé',
  other: 'Autre',
...
const pl = {
  ...
  save_signature_for_future_documents: 'Zapisz mój podpis do przyszłych dokumentów',
  save_initials_for_future_documents: 'Zapisz moje inicjały do przyszłych dokumentów',
...
const uk = {
  ...
  save_signature_for_future_documents: 'Зберегти мій підпис для майбутніх документів',
  save_initials_for_future_documents: 'Зберегти мої ініціали для майбутніх документів',
...
const cs = {
  ...
  save_signature_for_future_documents: 'Uložit můj podpis pro budoucí dokumenty',
  save_initials_for_future_documents: 'Uložit mé iniciály pro budoucí dokumenty',
...
const pt = {
  ...
  save_signature_for_future_documents: 'Salvar minha assinatura para documentos futuros',
  save_initials_for_future_documents: 'Salvar minhas iniciais para documentos futuros',
...
const he = {
  ...
  save_signature_for_future_documents: 'שמור את החתימה שלי למסמכים עתידיים',
  save_initials_for_future_documents: 'שמור את ראשי התיבות שלי למסמכים עתידיים',
...
const nl = {
  ...
  save_signature_for_future_documents: 'Mijn handtekening opslaan voor toekomstige documenten',
  save_initials_for_future_documents: 'Mijn initialen opslaan voor toekomstige documenten',
...
const ar = {
  ...
  save_signature_for_future_documents: 'حفظ توقيعي للمستندات المستقبلية',
  save_initials_for_future_documents: 'حفظ الأحرف الأولى من اسمي للمستندات المستقبلية',
...
const ko = {
  ...
  save_signature_for_future_documents: '향후 문서를 위해 내 서명 저장',
  save_initials_for_future_documents: '향후 문서를 위해 내 이니셜 저장',
...
const ja = {
  ...
  save_signature_for_future_documents: '今後の文書のために署名を保存',
  save_initials_for_future_documents: '今後の文書のためにイニシャルを保存',
  approved: '承認済み',
  reviewed: '確認済み',
  other: 'その他',
